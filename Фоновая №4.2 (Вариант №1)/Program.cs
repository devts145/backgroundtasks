...
namespace Фоновая__4._2__Вариант__1_
{
    class Weather1
    {
        ...
        public static Weather1 operator -- (Weather1 weather)
        {
            ...
            weather.TemperatureSv = newtemperature;
            return weather;
        }
        public static Weather1 operator ++ (Weather1 weather)
        {
            ...
            newtemperature[newtemperature.Length] = weather.FindAvarageTemperature();
            weather.TemperatureSv = newtemperature;
            return weather;
        }
        ...
        {
            get { return NumberZero(); }
        }
        public int[] TemperatureSv
        {
            get { return temperature; }
            set { this.TemperatureSv = value; }
        }
        public int MonthSv
        {
            get { return month; }
        ...
        public int Cold
        {
            get { return MostColdDay(); }
        }
        public int Hot
        {
            get { return MostHotDay(); }
        }
        ...
        public int FindAvarageTemperature()
        {
            int sum = 0;
            for (int i = 0; i < temperature.Length; i++)
            {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" ");
            weather--;
            Console.WriteLine("Результат перегруженного оператора декремента для первого дневника: ");
            weather.Output();
            weather++;
            Console.WriteLine(" ");
            Console.WriteLine("Результат перегруженного оператора инкремента для первого дневника: ");
            weather.Output();
